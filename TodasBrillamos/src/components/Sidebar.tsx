...
import { faUser, faTachometerAlt, faBox, faCog, faSignOutAlt } from '@fortawesome/free-solid-svg-icons'; // Importa los iconos que se usarán.
  ...
  return (
    <div className="sidebar"> {/* Contenedor principal de la barra lateral. */}
      ...
      <div className="sidebar__footer"> {/* Contenedor del pie de la barra lateral. */}
        <ul>
          <li>
            <Link to="/ajustes"> {/* Enlace a ajustes. */}
              <FontAwesomeIcon icon={faCog} className="sidebar__icon" /> Ajustes {/* Icono y texto. */}
            </Link>
          </li>
          <li>
