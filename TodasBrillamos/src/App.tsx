...
import Foro from "./pages/Forum";
import Anuncios from "./pages/Banner";
    ...
    <Router>
      ...
      <MainLayout onLogout={onLogout}> 
        <Routes>
          ...
          <Route path="/editarcuenta/:id" element={<AccountSettings />} /> {/* Página de ajustes de cuenta */}
          ...
          <Route path="/foro" element={<Foro />} /> {/* Página del foro */}
          <Route path="/anuncios" element={<Anuncios />} /> {/* Página de anuncios */}
          <Route path="/reset-password" element={<ResetPassword />} /> {/* Página de recuperación de contraseña */}
