    ...
    <Router>
      ...
      <MainLayout onLogout={onLogout}> 
        <Routes>
          ...
          <Route path="/añadirproductos" element={<AnadirProductos />} /> {/* Página para añadir productos */}
          <Route path="/cuentas" element={<Cuentas />} /> {/* Página de cuentas de usuario */}
          <Route path="/editarproductos" element={<EditarProducto />} /> {/* Página para editar productos */}
          <Route path="/añadiradministrador" element={<AnadirAdministrador />} /> {/* Página para añadir administrador */}
